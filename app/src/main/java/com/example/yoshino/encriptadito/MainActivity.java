...
public class MainActivity extends AppCompatActivity {
    ...
    public void ValidarSave(View view) {
        if (ObtenerAlfabeto01().length() == ObtenerAlfabeto02().length()) {
            if (metodos.contar(ObtenerAlfabeto01()) == 1 && metodos.contar(ObtenerAlfabeto02()) == 1) {
                ...
                lista01 = metodos.convertStringToArraylist(ObtenerAlfabeto01());
                lista02 = metodos.convertStringToArraylist(ObtenerAlfabeto02());
                saveArraySharedPreference(lista01, lista_alfabeto_1);
                saveArraySharedPreference(lista02, lista_alfabeto_2);
            }
            else {
...
boolean isInverso;
    ...
    public void EjecutarSaltos(View view) {
        ...
        alphabet1 = Crypto.successiveJumps(alphabet1, ObtenerClaveSaltos()+ObtenerIDSaltos(), isInicia);
        String newAvc =   metodos.getStringListCharacters(alphabet1);
        alfGenerado.setText(newAvc);}else {
